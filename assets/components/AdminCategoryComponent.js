...
const AdminCategoryComponent=({title,id,isNestedList,category})=>{

  const navigation = useNavigation()
  const [deleteCategory,{data,isSuccess,isError,error,isLoading}]= useDeleteCategoryMutation()
  ...
  const myIcon3 = <Icon1 name="trash" size={20}  color={Colors.red} />;
   ...
   const deleteCategoryHandler =()=>{
    Alert.alert('Delete', 'This will permanantly delete it', [
      ...
      {text: 'Delete', onPress: async() => await deleteCategory(id)},
    ]);
